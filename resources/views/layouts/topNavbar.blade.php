...
<!-- Mobile Navbar -->
<div class="fixed bottom-0 left-0 right-0 py-3 px-8 bg-white shadow-mobileNav md:px-40 lg:hidden z-20">
    <ul class="flex justify-between">
        <a href="{{ route('home') }}">
            <li class="flex justify-center flex-col items-center gap-1 text-second">
                <svg class="w-6" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M5 12H3l9-9l9 9h-2M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-7"/><path d="M9 21v-6a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v6"/></g></svg>
                <span class="text-xs font-bold md:text-sm">Beranda</span>
            </li>
        </a>
