...
<section class="px-5 md:px-12 lg:px-24">
    ...
    <div class="font-quick text-sm md:text-base">
        <div class="grid grid-cols-4 mt-0.5 md:grid-cols-8 lg:grid-cols-12">
            ...
            <div class="col-span-3 md:col-span-5 md:gap-5 lg:gap-7">
                <p>{{ Auth::user()->email }}<span class="ms-5 text-blue-500">Ubah</span></p>
            </div>
        </div>
        <div class="grid grid-cols-4 mt-0.5 md:grid-cols-8 lg:grid-cols-12">
            <p class="col-span-1 md:col-span-2">No. HP</p>
            <div class="col-span-3 md:col-span-5 md:gap-5 lg:gap-7">
                <p>{{ Auth::user()->phone }}<span class="ms-5 text-blue-500">Ubah</span></p>
            </div>
        </div>
    </div>
    <button class="font-quick text-sm border border-[#BDBDBD] rounded px-5 py-2 mt-3 md:text-base md:mt-4">Ubah Kata Sandi</button>
</section>
@endsection
